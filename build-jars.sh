...
VERSION=$(cat VERSION)
echo "version=$VERSION" > leshan/leshan-server-demo/src/main/resources/app-version.properties
echo "version=$VERSION" > leshan/leshan-client-demo/src/main/resources/app-version.properties
echo "version=$VERSION" > leshan/leshan-bsserver-demo/src/main/resources/app-version.properties
