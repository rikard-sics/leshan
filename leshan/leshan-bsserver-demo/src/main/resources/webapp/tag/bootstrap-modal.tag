        ...
        function submit(){
            ...
            if(lwserver.secmode === "EDHOC") {
                ...
                var dmEdhoc =
                {
                    ...
                    selectedCiphersuite : lwserverEdhoc.selectedCiphersuite,
                    clientKeyIdentifier : lwserverEdhoc.clientKeyIdentifier,
                    clientPublicKey : lwserverEdhoc.clientPublicKey,
            ...
            bsConfigStore.add(endpoint.value, {
                 dm:[{
                    ...
                    security : {
                        ...
                        serverId : 123,
                        peerPublicKey : lwserver.serverKey,
                        serverSmsNumber : "",
                        smsBindingKeyParam : [  ],
                        smsBindingKeySecret : [  ],
                 ...
                 bs:[{
                    security : {
                        ...
                        peerPublicKey : bsserver.serverKey,
                        serverSmsNumber : "",
                        smsBindingKeyParam : [  ],
                        smsBindingKeySecret : [  ],
                        smsSecurityMode : "NO_SEC",
